...
const reviews = [
  {
    ...
    rating: 5,
    comment: "تجربة تعليمية استثنائية. المحتوى العلمي دقيق جداً والمحاضرون على أعلى مستوى من الكفاءة الأكاديمية. الشهادة المعتمدة ساعدتني كثيراً في مساري المهني.",
    image: "/avatar-1.png",
  },
  {
    ...
    rating: 5,
    comment: "الدبلومة المهنية في الإدارة كانت تحولاً حقيقياً في فهمي للقيادة المؤسسية. نظام الدراسة الأونلاين مرن جداً ويناسب جداول العمل المزدحمة.",
    image: "/avatar-2.png",
  },
  {
    ...
    jobTitle: "معالج نفسي",
    rating: 5,
    comment: "أنصح بشدة ببرامج جامعة القاهرة التدريبية. المصداقية والاحترافية هي عنوان التعامل، والشهادة الموثقة بختم النسر هي بمثابة ضمان حقيقي للجودة.",
    image: "/avatar-3.png",
  },
];
    ...
    <section className="section-padding bg-slate-50 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-24 animate-fade-in-up">
          <div className="text-cu-blue font-black uppercase tracking-widest text-sm mb-4">قصص نجاح خريجينا</div>
          <h2 className="text-4xl md:text-6xl font-black text-slate-950 leading-tight arabic-heading">
            نحن فخورون <br />
            <span className="text-slate-400 font-bold italic">بشركاء النجاح</span>
          </h2>
        </div>
          ...
          {reviews.map((review, index) => (
            ...
            >
              ...
              <div className="flex items-center gap-5 mt-auto pt-10 border-t border-slate-200/50">
                ...
                <div>
                  <h4 className="text-xl font-black text-slate-950 leading-none mb-2">{review.studentName}</h4>
                  <p className="text-[10px] text-cu-blue font-black uppercase tracking-widest">{review.jobTitle}</p>
                </div>
              </div>
            </div>
          ))}
        ...
        <div className="mt-24 text-center border-t border-slate-200 pt-10">
          <p className="text-slate-400 font-bold uppercase tracking-[0.4em] text-xs">أكثر من 10,000 خريج معتمد في أنحاء الوطن العربي</p>
        </div>
      </div>
    </section>
  );
