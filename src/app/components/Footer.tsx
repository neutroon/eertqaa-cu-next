      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-20">
          ...
          <div className="lg:col-span-12 xl:col-span-5">
            <div className="flex items-center gap-6 mb-10 group">
              <div className="relative w-14 h-20 grayscale brightness-[3] transition-all group-hover:grayscale-0 group-hover:brightness-100">
                <Image src="/cu-logo.png" alt="جامعة القاهرة" fill className="object-contain" />
              </div>
              <div>
                <h3 className="text-3xl font-black arabic-heading leading-tight tracking-tight">برامج جامعة القاهرة</h3>
                <p className="text-xs uppercase tracking-[0.4em] font-black text-cu-gold mt-2">Official Educational Portal</p>
              </div>
            </div>
            <p className="text-slate-400 text-xl arabic-text leading-relaxed font-bold mb-12 max-w-xl">
              نحن نؤمن بأن التعليم عالي الجودة يجب أن يكون متاحاً لكل طموح. برامجنا في جامعة القاهرة مصممة لتمكين المحترفين العرب من خلال المعرفة الأكاديمية العميقة والخبرة العملية الواسعة.
            </p>
          ...
          <div className="md:col-span-6 lg:col-span-6 xl:col-span-3">
            <h4 className="text-2xl font-black mb-10 border-r-8 border-cu-blue pr-6 arabic-heading">خريطة المنصة</h4>
            <ul className="grid grid-cols-1 gap-6">
              {[
                { n: "البرامج التدريبية", h: "#courses" },
                { n: "عن جامعة القاهرة", h: "#about" },
                { n: "مميزات الدراسة", h: "#features" },
                { n: "التسجيل والإلتحاق", h: "#register" },
                { n: "منصة الدعم الفني", h: "#" }
              ].map((link) => (
                <li key={link.n}>
                  <a href={link.h} className="text-slate-400 hover:text-white text-lg font-bold transition-all flex items-center gap-4 group">
          ...
          <div className="md:col-span-6 lg:col-span-6 xl:col-span-4">
            <h4 className="text-2xl font-black mb-10 border-r-8 border-cu-red pr-6 arabic-heading">اعتمادات حكومية</h4>
            <div className="glass-dark rounded-[3rem] p-10 border border-white/5 relative overflow-hidden group">
              <div className="absolute top-0 right-0 w-32 h-32 bg-cu-red/10 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2" />
              <p className="text-slate-300 arabic-text leading-relaxed text-base font-bold mb-10 relative z-10">
                جميع شهادات البرامج المهنية صادرة رسمياً من جامعة القاهرة للتعليم المستمر، وتخضع لإشراف أكاديمي دقيق، وهي قابلة للتوثيق من الجهات التالية:
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 relative z-10">
                <div className="glass-modern !bg-white/5 p-5 rounded-[1.5rem] flex flex-col items-center gap-3 text-center border border-white/5 group-hover:bg-white/10 transition-all">
        ...
        <div className="mt-24 pt-16 border-t border-white/5 flex flex-col xl:flex-row justify-between items-center gap-12">
          <div className="order-2 xl:order-1">
            <p className="text-slate-500 text-base font-bold arabic-text text-center xl:text-right">
              &copy; {currentYear} جميع الحقوق محفوظة لبرامج جامعة القاهرة | Cairo University 
              <br className="md:hidden" />
              <span className="hidden md:inline mx-3 text-slate-800">|</span> 
          ...
          <div className="flex flex-wrap justify-center gap-8 text-xs font-black text-slate-600 uppercase tracking-[0.2em] order-1 xl:order-2">
            <a href="#" className="hover:text-cu-blue transition-all">الشروط والأحكام</a>
            <a href="#" className="hover:text-cu-blue transition-all">سياسة الخصوصية</a>
            <a href="#" className="hover:text-cu-blue transition-all">تواصل معنا</a>
          </div>
        </div>
      </div>

      {/* Modern Gradient Floor */}
      <div className="absolute bottom-0 left-0 w-full h-2 bg-gradient-to-r from-cu-blue via-cu-red to-cu-blue opacity-50 shadow-[0_0_20px_rgba(46,49,146,0.3)]" />
    </footer>
  );
}
